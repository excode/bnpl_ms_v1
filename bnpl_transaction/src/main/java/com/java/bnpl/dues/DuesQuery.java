...
public class DuesQuery  extends Dues{
	...
	@Getter @Setter private QueryEnum dueAmount_mode ;
	@Getter @Setter private Number[] dueAmount_array ;
	@Getter @Setter private QueryEnum dueDate_mode ;
	@Getter @Setter private QueryEnum latePaymentFeePolicy_mode ;
	@Getter @Setter private String[] latePaymentFeePolicy_array ;
