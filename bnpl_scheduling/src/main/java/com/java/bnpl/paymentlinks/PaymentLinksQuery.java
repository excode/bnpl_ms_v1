...
public class PaymentLinksQuery  extends PaymentLinks{
	...
	@Getter @Setter private QueryEnum paymentLinkURL_mode ;
	@Getter @Setter private String[] paymentLinkURL_array ;
	...
	@Getter @Setter private QueryEnum paymentAmount_mode ;
	@Getter @Setter private Number[] paymentAmount_array ;
