...
public class InstallmentsQuery  extends Installments{
	...
	@Getter @Setter private QueryEnum installmentNumber_mode ;
	@Getter @Setter private Number[] installmentNumber_array ;
	@Getter @Setter private QueryEnum installmentAmount_mode ;
	@Getter @Setter private Number[] installmentAmount_array ;
	@Getter @Setter private QueryEnum dueDate_mode ;
	@Getter @Setter private QueryEnum latePaymentFee_mode ;
	@Getter @Setter private Number[] latePaymentFee_array ;
	...
	@Getter @Setter private String[] customerId_array ;
