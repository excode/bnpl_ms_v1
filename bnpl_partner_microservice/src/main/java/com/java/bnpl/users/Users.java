...
public class Users extends Auditable {
    ...
    @Size(min = 1, max = 50, groups = { IDataAdd.class,
            IDataUpdate.class }, message = "lastname length error: should be between 1 and 50 chars")
    ...
    @Size(min = 6, max = 20, groups = { IDataAdd.class,
            IDataUpdate.class }, message = "password length error: should be between 6 and 20 chars")
    ...
    @Size(min = 8, max = 20, groups = { IDataAdd.class,
            IDataUpdate.class }, message = "mobile length error: should be between 8 and 20 chars")
