...
public class PlanQuery  extends Plan{
	@Getter @Setter private QueryEnum planName_mode ;
	@Getter @Setter private String[] planName_array ;
	...
	@Getter @Setter private QueryEnum noOfInstallment_mode ;
	@Getter @Setter private Number[] noOfInstallment_array ;
